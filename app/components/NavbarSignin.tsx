...
import Logo from "@/public/HobbyCue_Logo.png";
  ...
  return (
    <div className="flex shadow-lg bg-white justify-around px-[30px] lg:px-[150px] py-3">
      <div className="flex mr-10  items-center w-full ">
        <Image src={Logo} className="mr-5 w-[250px]" alt={""} />
        <input
          className="search lg:flex hidden border-y-2 placeholder:font-sans placeholder:pl-2 border-l-2 lg:w-[280px] bg-slate-50 font-sans rounded-s-lg p-2"
          placeholder="Search here..."
        />
        <div className="bg-[#8064A2]  lg:flex hidden justify-center font-bold  items-center rounded-r-lg w-20 md:w-11 h-11">
      ...
      <div className="flex   gap-x-8 justify-end items-center">
        ...
        <div className=" hidden lg:flex">
          <button className="border-2 border-[#8064A2] rounded-lg w-[150px] text-[#8064A2] font-semibold p-2 ">
            Sign In
          </button>
        </div>
